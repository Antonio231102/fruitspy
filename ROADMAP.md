...
Next: retain the direct and relay acceptance matrix while exercising packet loss, reordering, duplication, delay, abrupt client death, reconnects, process restarts, and isolated relay-state loss.
