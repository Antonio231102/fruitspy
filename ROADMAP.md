...
Next: retain the direct and relay acceptance matrix while verifying that the 15-minute hard relay TTL cannot terminate a legitimate supported game, then complete the two-residential-NAT and mixed local/remote hosting matrix.
